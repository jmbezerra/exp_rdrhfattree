...
def run_experiment(pod, density, ip="192.168.56.101", port=6653, bw_c2a=100, bw_a2e=100, bw_e2h=100):
	"""
	...
	fanout = args.k
	Controller_Ryu = Popen("ryu-manager --observe-links ./TCC/Hedera.py --k_paths=%d --weight=hop --fanout=%d" % (k_paths, fanout), shell=True, preexec_fn=os.setsid)
